 ...
 **/
@Entity
@Table(name = "t_sys_user_extend", schema = "supplierbidding", catalog = "")
public class UserExtend {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(urid, userid, extend1, extend2, extend3, extend4, extend5, extend6, extend7, extend8, extend9, extend10, extend11, extend12, extend13, extend14, extend15, extend16, extend17, extend18, extend19, extend20, createdby, createdon, updatedby, updatedon, reversion);
    }
}
