 ...
 **/
@Entity
@Table(name = "t_sys_expert_type", schema = "supplierbidding", catalog = "")
public class ExpertType {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(urid, code, name, parentid, createdby, createdon, updatedby, updatedon, reversion);
    }
}
